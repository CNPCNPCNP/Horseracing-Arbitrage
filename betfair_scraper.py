...
# url = "https://www.betfair.com.au/exchange/plus/horse-racing/market/1.206752802"
# test = BetfairRaceScraper(path, url, "CUTNPASTE", "SuperDuck!!1")

# while True:
#     print(test.get_lay_prices_trots())
#     test.refresh()
#     time.sleep(1)